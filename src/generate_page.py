...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path, basepath):
    ...
    for object in content:
        if os.path.isfile(os.path.join(dir_path_content, object)):
            print("isFile")
            generate_page(os.path.join(dir_path_content, object), template_path, os.path.join(dest_dir_path, object), basepath)
        if os.path.isdir(os.path.join(dir_path_content, object)):
            generate_pages_recursive(os.path.join(dir_path_content, object), template_path, os.path.join(dest_dir_path, object), basepath)